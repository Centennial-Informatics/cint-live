<script lang="ts">
	...
	import UpdateEnd from '$lib/utils/networking/admin/updateend';

	let time = '';
	async function onSubmit() {
		if (time)
			// make sure not empty
			await UpdateEnd($IDToken, time);
		time = '';
	}
</script>

<div>
	<SectionTitle>Update End Time</SectionTitle>
	<Subtitle>2006-01-02T15:04:05Z07:00 Format</Subtitle>
